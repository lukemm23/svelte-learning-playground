    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-vzeg3x");
    			add_location(h1, file$1, 39, 0, 646);
    			add_location(button0, file$1, 40, 0, 695);
    			add_location(button1, file$1, 41, 0, 747);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "Enter Name");
    			add_location(input0, file$1, 53, 0, 1070);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "placeholder", "Enter Job Title");
    			add_location(input1, file$1, 54, 0, 1135);
    			attr_dev(input2, "type", "text");
    			add_location(input2, file$1, 55, 0, 1206);
    			attr_dev(textarea, "type", "text");
    			attr_dev(textarea, "placeholder", "Enter a short description");
    			add_location(textarea, file$1, 56, 0, 1247);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
